...
final listImage = [
  sliderWidget('Introducing \nbranchX Gold', 'Buy digital gold, sell gold, \nJewelry and get gold coins.', 'Register now', Resource.xeniePhoto_image ),
  sliderWidget('Refer Your \nfriends', 'Earn Rupee 150/- for every\nSuccessful refer', 'Refer & Earn', Resource.xeniePhoto_image ),
  sliderWidget('Get Your RAJA RANI\ncombo today!', 'Withdraw money from\nanywhere in India.', 'Apply Now', Resource.xeniePhoto_image ),
  sliderWidget('Suraksha with\nbranchX!', 'With your cards, get 1 lakh\nfree insurance policy.','Activate Now', Resource.xeniePhoto_image ),
...
class _SlidingCarouselState extends State<SlidingCarousel> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
         CarouselSlider(items: listImage,
          ...
          Row(
            ...
            children: listImage.map((urlOfItem) {
              int index = listImage.indexOf(urlOfItem);
              return Container(
                width: 8.0,
                height: 8.0,
...
Widget sliderWidget( String title, String subTitle, String buttonLabel, String carousel_image ) {
  return Padding(
