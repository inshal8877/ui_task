...
class SecondBlueCard extends StatefulWidget {
  bool isSecondBlueCardFront= true;
  SecondBlueCard({  Key? key}) : super(key: key);

  @override
  State<SecondBlueCard> createState() => _SecondBlueCardState();
}

class _SecondBlueCardState extends State<SecondBlueCard> {
  // double value 0;
      ...
      children: [
        Transform(
          ...
          child: Card(
            ...
            child: Container(
              ...
              child: (widget.isSecondBlueCardFront) ? secondBlueCardFront() : secondBlueCardBack() ,
            ),
          ),
        ),
        ...
        Positioned(
          ...
          child: GestureDetector(child: Image.asset(Resource.cardButtonBlue_image),
            onTap: () =>  setState(() {
              widget.isSecondBlueCardFront = ! widget.isSecondBlueCardFront ;
    ...
    child: Column(
      ...
      children: [
        ...
        Row(
          children: [
             Expanded(
              child: Text('My Wallet'.toUpperCase() , style: TextStyle(color: Color(0xffF0EFEF),
                fontFamily: 'Rubik', fontSize: 16.sp, fontWeight: FontWeight.bold,),),
            ),
            Text('Complete Kyc'.toUpperCase(), style: TextStyle(color: Color(0xffF0EFEF),
        ...
        Row(
          ...
          children: [
            ElevatedButton(
              child: Text('Complete Kyc'.toUpperCase(), style: const TextStyle(color: Colors.white, fontFamily: 'Rubik', fontSize: 12, fontWeight: FontWeight.normal),),
            ...
            ElevatedButton(
              child: Text('Details'.toUpperCase(), style: const TextStyle(color: Color(0xff1C0E59), fontFamily: 'Rubik', fontSize: 12, fontWeight: FontWeight.normal),),
